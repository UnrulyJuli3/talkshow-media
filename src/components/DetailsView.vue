...
<template>
    <template v-if="loaded">
        ...
        <div class="form-check mt-4">
            <input class="form-check-input" type="checkbox" id="show-details" v-model="showDetails" />
            <label class="form-check-label" for="show-details">Show expansive details</label>
        </div>
            ...
            <table class="table mt-2">
                ...
                <tbody>
                    <tr v-for="pkg in packages">
                        ...
                        <td v-if="showDetails"><a :href="`#package-${pkg.id}-details`">{{ pkg.name }}</a></td>
                        <td v-else>{{ pkg.name }}</td>
            ...
            <table class="table mt-2">
                ...
                <tbody>
                    <tr v-for="template in exp!.templates">
                        ...
                        <td v-if="showDetails"><a :href="`#template-${template.id}-details`">{{ template.name }}</a></td>
                        <td v-else>{{ template.name }}</td>
